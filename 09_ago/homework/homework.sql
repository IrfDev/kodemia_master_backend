...
CREATE TABLE IF NOT EXISTS film_reviews (
    ...
    review TEXT,
    CONSTRAINT pk_film FOREIGN KEY (film_id) REFERENCES film (film_id),
    CONSTRAINT pk_customer FOREIGN KEY (customer_id) REFERENCES customer (customer_id)
);
...
-- 1st MOVIE
INSERT INTO
    film_reviews(film_id, customer_id, review)
VALUES
    (49, 603, 'Excellent');
